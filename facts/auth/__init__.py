...
from . import (active_workspace, admin, device, device_invite, endpoint,
               invite_accepted, local_signer_secret, signature, user, user_invite,
               workspace)
...
SCOPE = Router({b"workspace": workspace, b"user": user, b"user_invite": user_invite,
                ...
                b"active_workspace": active_workspace,
