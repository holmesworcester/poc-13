"""facts/content/channel.py — a named, workspace-scoped message channel.
...
shareable structural state and are pulled whole by channel queries."""
...
def create(node, workspace_id, name, t):
    ...
    return node.admit(encode(channel(workspace_id, name, t)))
